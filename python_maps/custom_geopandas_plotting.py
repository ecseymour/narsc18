...
def plot_dataframe_custom(df, column=None, cmap=None, color=None, ax=None,
                   categorical=False, legend=False, scheme=None, k=5,
                   vmin=None, vmax=None, figsize=None, legend_kwds=None, cust_labels=None,
                   **style_kwds):
    """
    Plot a GeoDataFrame.
    ...
    **style_kwds : dict
    ...
    if legend and not color:
        ...
        if categorical:
            ...
            ax.legend(patches, cust_labels, **legend_kwds)
        else:
            n_cmap.set_array([])
