...
codebook = "/home/eric/Documents/franklin/narsc2018/source_data/census/nhgis0059_csv/nhgis0059_ts_nominal_county_codebook.txt"
...
with open(codebook, 'rb') as f:
	for line in f:
		if "Table 1: (AW9) Persons by Hispanic or Latino Origin" in line:
			break
	for line in f:
		if "---" in line:
			break
...
tablename = 'county_hispanic_origin_age'
...
datafile = "/home/eric/Documents/franklin/narsc2018/source_data/census/nhgis0059_csv/nhgis0059_ts_nominal_county.csv"
